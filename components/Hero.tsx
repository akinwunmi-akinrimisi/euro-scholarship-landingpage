        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 pt-6">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-brand-50 text-brand-800 text-xs font-bold tracking-widest uppercase mb-8 border border-brand-100">
                <span className="w-2 h-2 rounded-full bg-brand-600 mr-2 animate-pulse"></span>
                The Safest Way to "Japa" in 2026
              </div>
              <h1 className="text-4xl tracking-tight font-bold text-slate-900 sm:text-5xl md:text-6xl lg:leading-tight">
                <span className="block">Your Academic Path to</span>
                <span className="block text-brand-700 italic">European Residency</span>
              </h1>
              <p className="mt-6 text-base text-slate-600 sm:mt-8 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-8 md:text-xl lg:mx-0 leading-relaxed font-light">
              ...
              <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center px-10 py-4 border border-transparent text-base font-semibold rounded-lg text-white bg-brand-800 hover:bg-brand-900 md:text-lg transition-all shadow-lg hover:shadow-brand-500/30 transform hover:-translate-y-0.5"
                >
                  <Download className="w-5 h-5 mr-3" />
                  Access the 2026 List
                </button>
              </div>
              <div className="mt-8 pt-8 border-t border-slate-100 flex flex-col sm:flex-row gap-4 text-sm text-slate-500 sm:justify-center lg:justify-start">
