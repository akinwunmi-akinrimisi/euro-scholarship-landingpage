    ...
    <div className="py-24 bg-slate-50" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-sm font-bold text-brand-700 tracking-widest uppercase mb-3">Why Choose the Education Route?</h2>
          <p className="text-3xl font-bold text-slate-900 sm:text-4xl font-serif">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div key={feature.title} className="bg-white rounded-xl p-8 shadow-sm border border-slate-100 hover:shadow-premium transition-all duration-300 group">
              <div className="flex items-center justify-center h-14 w-14 rounded-lg bg-brand-50 text-brand-700 mb-6 group-hover:bg-brand-600 group-hover:text-white transition-colors">
